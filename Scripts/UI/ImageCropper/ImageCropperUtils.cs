using UnityEngine;
using Orientation = Gamla.GUI.ImageCropper.ImageCropper.Orientation;
...
namespace Gamla.GUI.ImageCropper
{
	public static class ImageCropperUtils
	{
		...
		public static ImageCropper.Orientation GetExifFixOrientation( this ImageCropper.Orientation exifOrientation )
		{
